...
class TestDataprepServiceLiveGCS:
    ...
    def test_initialize_gcs_test_environment(self, test_tenant):
        ...
        if placeholder_run:
            ...
            print("ℹ️ Run folders already exist for testing")

        if _ensure_test_video_assets(test_tenant, manager=manager):
            print("✅ Ensured test video and detection assets are available in GCS")
        else:
            print("⚠️ Could not ensure test video assets; downstream tests may skip")
