...
def test_train_endpoint_forwards_eval_params(monkeypatch):
    ...
    monkeypatch.setattr(train_endpoint, 'create_job', fake_create_job)
    monkeypatch.setattr(train_endpoint, 'start_job', fake_start_job)
    ...
    assert captured['eval_params'] == {'batch_size': 4, 'num_workers': 0}
