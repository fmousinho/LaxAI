"""
Shared fixtures    # Mock computer vision and ML libraries (but keep supervision, torch, torchvision and PIL real)
    cv2_mock = Mock()
    ...
    # sys.modules['PIL.Image'] = Mock()  # Keep PIL real for supervision compatibilitynfiguration for TrackGeneratorPipeline tests.

This conftest.py provides common test fixtures that can be used across
all test modules in the track test suite.
"""
