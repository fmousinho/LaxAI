...
class ThreadSafetyManager:
        ...
        try:
            if mp.get_start_method(allow_none=True) is None:
                if sys.platform == 'darwin':  # macOS
                    ...
                    mp.set_start_method('spawn', force=True)  # Use spawn for all platforms for consistency
    ...
    def configure_for_training(self, num_workers: Optional[int] = None, enable_multithreading: bool = True):
        """
    ...
    def get_safe_dataloader_kwargs(self, num_workers: Optional[int] = None, enable_multithreading: bool = True) -> Dict[str, Any]:
        """
...
@contextmanager
def safe_multiprocessing_context(enable_multithreading: bool = True, num_workers: Optional[int] = None):
    """
    ...
    original_env = {
        key: os.environ.get(key) for key in [
            ...
            'TORCH_NUM_THREADS', 'OPENBLAS_NUM_THREADS'
        ]
    }
...
def get_optimal_worker_count(enable_multithreading: bool = True, max_workers: Optional[int] = None) -> int:
    """
