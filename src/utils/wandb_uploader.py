...
NODEL_PATH = "data/common-models-detection_latest.pth"
...
def upload_detection_model_to_wandb(
    ...
    if not wandb_api_key:
        logger.error("WANDB_API_KEY not found in environment variables or .env file. Skipping upload.")
        return
    else:
    ...
    try:
        ...
        logger.info(f"Initializing project {wandb_config.project} with entity {wandb_config.entity}")
        run = wandb.init(
