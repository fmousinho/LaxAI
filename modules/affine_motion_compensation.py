...
class AffineAwareByteTrack(sv.ByteTrack):
    """
    A custom ByteTrack tracker that incorporates affine motion compensation.
    ...
    def update_with_transform(self, detections: sv.Detections, affine_matrix: np.ndarray) -> sv.Detections:
        """
        ...
        return super().update_with_detections(detections)
