...
def cleanup_wandb_artifacts():
    ...
    try:
        ...
        try:
                    ...
                    for collection in collections:
                        try:
                            ...
                            if (collection.name.startswith("test-") or 
                                ...
                                "cleanup_test" in collection.name or
                                "test_model" in collection.name or
                                "test_cleanup" in collection.name or
                                "test_training_sim" in collection.name or
                                "test_memory_leak" in collection.name):
            ...
            if total_deleted > 0:
                print(f"🧹 Cleaned up {total_deleted} test artifacts total from comprehensive test suite")
            else:
