...
class TestURLLogging:
    ...
    def pipeline(self, mock_config, mock_storage_client):
        ...
        with patch('unverified_track_generator_pipeline.get_storage', return_value=mock_storage_client), \
             ...
             patch('unverified_track_generator_pipeline.training_config', mock_config), \
    ...
    @patch('unverified_track_generator_pipeline.logger')
