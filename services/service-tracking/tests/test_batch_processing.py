...
from track.unverified_track_generator_pipeline import CROP_BATCH_SIZE, MAX_CONCURRENT_UPLOADS, FRAME_SAMPLING_FOR_CROP
...
def test_frame_level_checkpointing():
    ...
    try:
        from track.unverified_track_generator_pipeline import CHECKPOINT_FRAME_INTERVAL
